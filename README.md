...
![Version](https://img.shields.io/badge/version-2.0.2-violet.svg)

## 📸 스크린샷

![App Screenshot](./screenshot/screen1.png)

## 🚀 최신 버전: v2.0.2 (2026.07.01)
이번 업데이트는 채팅 오버레이 인피니티 스크롤 동작 시 과거 채팅 이력에서 캐릭터의 에타 레벨이 표시되지 않던 버그를 수정한 핫픽스 릴리즈입니다.
