...
![Version](https://img.shields.io/badge/version-1.17.9-violet.svg)

## 📸 스크린샷

![App Screenshot](./screenshot/screen1.png)

## 🚀 최신 버전: v1.17.9 (2026.06.06)
이번 업데이트는 모험일지의 경험의 정수 기록 방식을 건당 개별 기록으로 원복하고 삭제 버튼을 예외 처리했으며, 일일 요약 영역 신설 및 주간/월간 통계에 경험의 정수 개수를 추가 반영하였습니다.

- **📜 경험의 정수 기록 개별화**: 정수 획득 시 타임라인에 한 줄씩 개별 등록되며, 수동 삭제 실수 방지를 위해 삭제 버튼이 보이지 않도록 예외 처리했습니다.
- **✨ 일일/주간/월간 통계 및 요약 영역 확장**: 일일 요약 정보 영역을 신설하였고 주간/월간 통계에 경험의 정수 집계를 추가했습니다.
- **🔒 채팅 오버레이 개별 투명도 조절 지원**: 메인, 서브1, 서브2 오버레이 창의 투명도를 개별적으로 조절할 수 있는 개별 슬라이더를 환경 설정에 추가했습니다.
...
### 설치 방법
[Releases](https://github.com/drt0927/tw-overlay/releases) 페이지에서 최신 버전의 `twOverlay-Setup-1.17.9.exe` 파일을 다운로드하여 실행하세요.
