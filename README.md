...
*   **✅ 일일/주간 숙제 체크 리스트 (New):** 테일즈위버의 30여종 기본 숙제와 커스텀 항목을 체계적으로 관리하세요. 지능형 자동 초기화와 실시간 검색 기능을 제공합니다.
...
### 1. 설치하기
[Releases](https://github.com/drt0927/tw-overlay/releases) 페이지에서 최신 버전의 `twOverlay-Setup-1.7.0.exe` 파일을 다운로드하여 설치하세요. 기존 사용자는 앱 내 업데이트 기능을 사용할 수 있습니다.
