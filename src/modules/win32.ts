...
// --- GDI & Window Capture API ---
export const GetDC = user32.func('__stdcall', 'GetDC', 'intptr', ['intptr']);
export const ReleaseDC = user32.func('__stdcall', 'ReleaseDC', 'int', ['intptr', 'intptr']);
const gdi32 = koffi.load('gdi32.dll');
export const CreateCompatibleDC = gdi32.func('__stdcall', 'CreateCompatibleDC', 'intptr', ['intptr']);
export const CreateCompatibleBitmap = gdi32.func('__stdcall', 'CreateCompatibleBitmap', 'intptr', ['intptr', 'int', 'int']);
export const SelectObject = gdi32.func('__stdcall', 'SelectObject', 'intptr', ['intptr', 'intptr']);
export const BitBlt = gdi32.func('__stdcall', 'BitBlt', 'bool', ['intptr', 'int', 'int', 'int', 'int', 'intptr', 'int', 'int', 'uint32']);
export const DeleteObject = gdi32.func('__stdcall', 'DeleteObject', 'bool', ['intptr']);
export const DeleteDC = gdi32.func('__stdcall', 'DeleteDC', 'bool', ['intptr']);
export const GetDIBits = gdi32.func('__stdcall', 'GetDIBits', 'int', ['intptr', 'intptr', 'uint', 'uint', 'void *', 'void *', 'uint']);
