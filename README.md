...
![Version](https://img.shields.io/badge/version-1.18.5-violet.svg)

## 📸 스크린샷

![App Screenshot](./screenshot/screen1.png)

## 🚀 최신 버전: v1.18.5 (2026.06.18)
이번 업데이트는 **이클립스 로카고스 기믹 시각적 알림 추가 및 기믹 기본 설정값 조정**이 적용되었습니다.

- **🛡️ 이클립스 로카고스 보스 기믹 알림 구현**: 로카고스의 마법 공격 대사를 추적하여, 대피 및 회피 기믹에 맞추어 큼직한 원형 네온 뱃지와 화면 테두리 플래시를 통해 직관적인 가이드를 제공합니다.
- **⚙️ 기믹 알림 기본값 설정 조정**: 사용자 편의를 고려하여 기믹 알림(에토스, 심연의 제2사도, 로카고스)의 최초 기본 활성화 상태를 `false`(사용 안 함)로 일관되게 정정했습니다.
