...
![Version](https://img.shields.io/badge/version-1.14.3-violet.svg)

## 📸 스크린샷

![App Screenshot](./screenshot/screen1.png)

## 🚀 최신 버전: v1.14.3 (2026.06.01)
이번 업데이트는 **게임이 종료되었을 때 백그라운드 알림 소리가 들리지 않도록 수정**한 패치 버전입니다.

- **🔊 게임 종료 시 알람 소리 차단**: 테일즈위버 게임이 꺼진 백그라운드 상주 상태에서 필드보스, 버프 타이머 등의 실시간 알림음이 중복 재생되는 버그를 완전히 제어했습니다. (사이드바 수동 미리듣기는 유지)
...
### 설치 방법
[Releases](https://github.com/drt0927/tw-overlay/releases) 페이지에서 최신 버전의 `twOverlay-Setup-1.14.3.exe` 파일을 다운로드하여 실행하세요.
