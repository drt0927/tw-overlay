...
![Version](https://img.shields.io/badge/version-1.14.1-violet.svg)

## 📸 스크린샷

![App Screenshot](./screenshot/screen1.png)

## 🚀 최신 버전: v1.14.1 (2026.05.26)
이번 업데이트는 **경험치 HUD 오버레이 창에 '잡은 몬스터' 마리수 실시간 표시 기능**이 추가되고, 세션 초기화 시 수치 연동 버그를 보완한 패치 버전입니다.

- **📊 경험치 HUD 오버레이에 '잡은 몬스터' 표시 추가**: 기존의 총 경험치, 분당 경험치 항목 아래에 '잡은 몬스터' 마리수를 실시간으로 누적 표기해 주는 기능을 추가하여 사냥 현황 파악을 극대화했습니다.
- **⏱️ 세션 초기화 시 몬스터 처치 수 동기화 개선**: 경험치 세션을 수동 초기화할 때, 화면상의 잡은 몬스터 수 역시 즉각 `0`으로 초기화되도록 보완했습니다.
...
### 설치 방법
[Releases](https://github.com/drt0927/tw-overlay/releases) 페이지에서 최신 버전의 `twOverlay-Setup-1.14.1.exe` 파일을 다운로드하여 실행하세요.
