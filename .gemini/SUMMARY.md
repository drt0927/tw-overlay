# TalesWeaver Companion Browser (TW-Overlay) 프로젝트 가이드 (v1.6.2)

이 문서는 v1.6.2 버전을 기준으로 작성되었습니다.
...
- **업데이트 히스토리 (v1.6.2 핵심)**
- **UI/사용성:** 마우스 호버 기반 오버레이 툴바 자동 숨김 기능 추가 및 마우스 투과 모드 시 즉각적인 툴바 비활성화 안정성 확보.
- **창 관리 고도화:** 오버레이 포커스 시 게임 클라이언트의 Z-Order 동반 상승 처리 로직 구현.
