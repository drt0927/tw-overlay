...
![Version](https://img.shields.io/badge/version-1.18.6-violet.svg)

## 📸 스크린샷

![App Screenshot](./screenshot/screen1.png)

## 🚀 최신 버전: v1.18.6 (2026.06.19)
이번 업데이트는 **지능형 버프 타이머 설정 시간 변경 및 단축키 실행 시 프레임 드랍 개선**이 적용되었습니다.

- **⏱️ 지능형 버프 타이머 설정 변경**: 얼리버드 경험치 부스터 및 최상급 에오스의 파편의 버프 타이머 기본 지속시간 설정을 1시간에서 30분으로 변경하여 실제 게임 스펙에 맞췄습니다.
- **⚡ 단축키 프레임 드랍 개선**: 단축키나 설정 조작 시 발생하던 동기식 디스크 저장(I/O) 연산을 비동기식 디바운싱 방식으로 개선하여 메인 루프 지연으로 인한 프레임 드랍 현상을 해결했습니다.
