...
![Version](https://img.shields.io/badge/version-1.14.2-violet.svg)

## 📸 스크린샷

![App Screenshot](./screenshot/screen1.png)

## 🚀 최신 버전: v1.14.2 (2026.05.26)
이번 업데이트는 **몬스터 웨이브 종료 대기 알림 기능**이 추가되고, **환경 설정 내 기믹/시스템 알림 UI를 통합 리팩토링**한 패치 버전입니다.

- **🌊 몬스터 웨이브 종료 대기 알림 추가**: 웨이브 진행 시 몬스터를 다 잡지 않으면 진행이 멈추는 구간에서 화면 중앙에 보라색 알림 팝업을 표시하고 지정 오디오 경보를 울려줍니다.
- **⚙️ 기믹 및 시스템 알림 환경설정 통합**: 파편화되어 흩어져 있던 에토스, 제2사도 기믹 설정을 "인게임 기믹 및 시스템 알림" 단일 탭으로 병합하고 리스트 형태로 구성해 관리 편의성을 높였습니다.
...
### 설치 방법
[Releases](https://github.com/drt0927/tw-overlay/releases) 페이지에서 최신 버전의 `twOverlay-Setup-1.14.2.exe` 파일을 다운로드하여 실행하세요.
