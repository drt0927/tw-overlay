...
![Version](https://img.shields.io/badge/version-1.12.6-violet.svg)

## 📸 스크린샷

![App Screenshot](./screenshot/screen1.png)

## 🚀 최신 버전: v1.12.6 (2026.05.15)
이번 업데이트는 **모험일지 주간 리포트 기능 추가 및 사이드바 노출 안정성 강화**를 주요 목표로 합니다.

- **📅 주간 상세 리포트 추가**: 달력의 'W' 영역을 클릭하여 해당 주간의 숙제 달성도, 보스 처치 횟수, 총 획득 수익을 한눈에 파악할 수 있는 요약 대시보드를 제공합니다.
- **📈 주차별 수익 통계**: 통계 리포트 탭에서 이번 달의 주차별 수익 흐름을 직관적으로 확인할 수 있도록 개선되었습니다.
- **🛡 사이드바 노출 버그 수정**: 게임 종료 또는 최소화 상태에서 알람(보스 등)이 발생할 때 사이드바가 화면에 비정상적으로 나타나던 문제를 해결했습니다.
- **🕒 시간 표기 개선**: 모험일지 타임라인의 시간 표시 형식을 'HH:mm'으로 통일하여 가독성을 높였습니다.
...
### 설치 방법
[Releases](https://github.com/drt0927/tw-overlay/releases) 페이지에서 최신 버전의 `twOverlay-Setup-1.12.6.exe` 파일을 다운로드하여 실행하세요.
