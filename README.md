...
![Version](https://img.shields.io/badge/version-2.0.5-violet.svg)

## 📸 스크린샷

![App Screenshot](./screenshot/screen1.png)

## 🚀 최신 버전: v2.0.5 (2026.07.04)
이번 업데이트는 팔색조 언덕의 일일 숙제 카운팅 개선 및 디스코드 알람 스팸 제외 필터를 담은 **패치 v2.0.5 업데이트**입니다.
...
- **💬 디스코드 알림 클럽 공지 제외 필터 추가**:
  * 지정 단어 알림과 감지 규칙을 동일하게 정렬하여, '클럽 공지' 발신자의 메시지가 디스코드 알림 웹훅을 불필요하게 트리거하지 않도록 예외 필터를 추가했습니다.
