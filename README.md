...
![Version](https://img.shields.io/badge/version-1.11.1-violet.svg)
...
### 📊 실시간 게임 데이터 분석 (신규)
- **[경험치 HUD (XP/EPM)](./docs/overlay.md)**: 실시간 획득 경험치 및 분당 경험치(EPM) 오버레이 표시
...
### 설치 방법
[Releases](https://github.com/drt0927/tw-overlay/releases) 페이지에서 최신 버전의 `twOverlay-Setup-1.11.1.exe` 파일을 다운로드하여 실행하세요.
