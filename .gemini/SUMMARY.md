...
이 문서는 TypeScript 전환 및 4분할 창 시스템이 적용된 v1.0.5 버전을 기준으로 작성되었습니다.
...
## 5. 업데이트 히스토리 (v1.0.5 핵심)
- **TypeScript 전환 완료.**
- **4분할 독립 창 아키텍처 도입.**
- **1.0.4 안정 버전의 자석 추적 로직 복구 및 정밀화.**
- **와이드 대시보드 및 무한 스크롤 아이콘 피커 구현.**
- **사용자 커스텀 위치(Offset) 계층형 저장 시스템 구축.**
