...
![Version](https://img.shields.io/badge/version-1.12.8-violet.svg)

## 📸 스크린샷

![App Screenshot](./screenshot/screen1.png)

## 🚀 최신 버전: v1.12.8 (2026.05.15)
이번 업데이트는 **커스텀 숙제 관리 기능 강화 및 다중 캐릭터 시스템 안정화**를 주요 목표로 합니다.

- **🛠 커스텀 숙제 편집 지원**: 이제 추가된 커스텀 숙제의 이름, 카테고리, 초기화 규칙을 언제든 자유롭게 수정할 수 있습니다. 
- **📅 다중 캐릭터 숙제 체크리스트 개선**: Matrix View에서 커스텀 숙제 항목별로 편집/삭제 버튼이 추가되어 관리가 더 용이해졌습니다.
...
### 설치 방법
[Releases](https://github.com/drt0927/tw-overlay/releases) 페이지에서 최신 버전의 `twOverlay-Setup-1.12.8.exe` 파일을 다운로드하여 실행하세요.
