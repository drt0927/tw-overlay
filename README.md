...
![Version](https://img.shields.io/badge/version-1.15.1-violet.svg)

## 📸 스크린샷

![App Screenshot](./screenshot/screen1.png)

## 🚀 최신 버전: v1.15.1 (2026.06.02)
이번 업데이트는 **버프 타이머 사운드 기본값 설정 오류 및 불일치 버그**를 수정한 패치 버전입니다.

- **🔊 버프 타이머 사운드 기본값 일치**: 버프 알림 사운드를 지정하지 않았을 때 UI상으로는 '기본 알림'으로 선택된 것처럼 보이나 실제 백엔드에서는 보스 사운드('일단은 보스부터 쓰러뜨리자')가 재생되던 현상을 해결하여 '기본 알림'(orb.mp3)으로 통일했습니다.
...
### 설치 방법
[Releases](https://github.com/drt0927/tw-overlay/releases) 페이지에서 최신 버전의 `twOverlay-Setup-1.15.1.exe` 파일을 다운로드하여 실행하세요.
