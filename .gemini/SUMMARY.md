# TalesWeaver Companion Browser (TW-Overlay) 프로젝트 가이드 (v1.6.1)

이 문서는 **오버레이 창 이동 제한 해제** 기능이 추가된 v1.6.1 버전을 기준으로 작성되었습니다.
...
- **업데이트 히스토리 (v1.6.1 핵심)**
- **기능 개선:** 오버레이 창이 게임 창 내부로만 제한되던 동작을 수정하여, 모니터 어디로든 자유롭게 이동할 수 있도록 개선.
- **동기화 유지:** 게임 창을 이동시켜도 오버레이가 설정된 상대 오프셋을 유지하며 함께 이동하도록 로직 고도화.
